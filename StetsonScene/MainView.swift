    ...
    var body: some View {
        HStack(spacing: 20){
            ...
            HStack {
                ...
                .background(viewRouter.currentPage == "Trending" ? Color.blue.opacity(0.3) : Color.clear)
                .clipShape(Capsule())
            ...
            HStack {
                ...
                .background(viewRouter.currentPage == "Discover" ? Color.blue.opacity(0.3) : Color.clear)
                .clipShape(Capsule())
            ...
            HStack {
                ...
                .background(viewRouter.currentPage == "Favorites" ? Color.blue.opacity(0.3) : Color.clear)
                .clipShape(Capsule())
            ...
            HStack {
                ...
                .background(viewRouter.currentPage == "Information" ? Color.blue.opacity(0.3) : Color.clear)
                .clipShape(Capsule())
