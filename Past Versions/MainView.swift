...
struct TabBar : View {
    ...
    var body: some View {
        ...
        if self.viewRouter.showOptions {
            TabOptions().offset(x: self.viewRouter.page == "Discover" ? -Constants.width/10 : Constants.width/10, y: -Constants.height/10)
        }
    ...
    var body: some View {
        HStack {
            ...
            ZStack {
                ...
                .foregroundColor(self.viewRouter.subPage == "List" ? Color(Constants.accent1) : Color(Constants.bg2))
                .padding(15)
